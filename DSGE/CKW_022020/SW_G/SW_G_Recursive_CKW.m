...
settings.est.recursive_shock_pos = 1; % which is recursively defined shock?
...
settings.est.recursive_shock = 1; % not use recursive shock
...
SW_model.VAR_irf = compute_VARirfs_DSGE(SW_model,settings);

%----------------------------------------------------------------
% Compute Target IRF
%----------------------------------------------------------------

SW_model.target_irf = SW_model.VAR_irf(settings.est.IRF_select, :);
...
save('SW_G_Recursive_CKW','SW_model','settings','results','-v7.3');
