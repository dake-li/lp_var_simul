...
mat_files = {{'SW_DFM_G_IV_CKW', 'SW_DFM_G_ObsShock_CKW', 'SW_DFM_G_Recursive_CKW'}, ...
             {'SW_DFM_MP_IV_CKW', 'SW_DFM_MP_ObsShock_CKW', 'SW_DFM_MP_Recursive_CKW'}}; % Files corresponding to above folders
