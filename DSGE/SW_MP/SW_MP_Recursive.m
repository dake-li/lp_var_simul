...
settings.est.shock_optimize_var      = 3; % for which variable in full model to choose optimal linear combination of shocks 
ettings.est.recursive_shock_pos = 3; % which is recursively defined shock?
...
clear temp_largest_root_svar temp_LM_stat_svar temp_lambda_lp_penalize temp_weight_var_avg
...
clear results_largest_root_svar results_LM_stat_svar results_lambda_lp_penalize results_weight_var_avg
clear i_method thisMethod
