function [dcov, dlrv] = dcov_dlrv(ABCD)
    ...
    % We do this by computing the implied ABCD model
    ...
    % Reduced-rank representation of A-I=alpha*beta'
    [U,S,V] = svd(A-eye(n_s));
    ...
    % Compute var-cov and long-run var-cov of dy_t
