...
settings.est.shock_optim_var     = 3; % for which variable in full model to choose optimal linear combination of shocks 
...
save('SW_MP_Recursive_CKW','SW_model','settings','results','-v7.3');
